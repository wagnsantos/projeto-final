...
const Servidores = () => {
  ...
  async function buscarEquipamentos() {
    try {
      ...
      const filtrados = resposta.filter((item: any) => item.type?.toLowerCase() === 'servidor');
  ...
  async function handleCadastro() {
    ...
    try {
      await cadastrarEquipamento({ name: nome, type: 'servidor' });
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Central dos Servidores</Text>
